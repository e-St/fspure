<!--
  ...
  Channel: preview | Ref: local-test | Generated: 2026-08-10T18:37:28Z
-->
...
Stable Markdown on `main` is refreshed **only on official releases**. Preview: `https://fspure.net/preview/local-test`.
