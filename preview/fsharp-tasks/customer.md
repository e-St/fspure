<!--
  ...
  Channel: preview | Ref: fsharp-tasks | Version: 0.4.0
  Generated: 2026-08-10T19:53:32Z
-->
...
> Preview docs for `fsharp-tasks`. Stable guide: [fspure.net](https://fspure.net) / [main README](https://github.com/e-St/fspure#60-second-install).
...
- Analyzer: **0.4.0**  
- Collector: **0.1.0**  
- Docs channel: **preview** (`fsharp-tasks`)
