...
> Preview docs for `human-check`. Stable guide: [fspure.net](https://fspure.net) / [main README](https://github.com/e-St/fspure#60-second-install).
...
- Analyzer: **0.4.0**  
- Collector: **0.1.0**  
- Docs channel: **preview** (`human-check`)
