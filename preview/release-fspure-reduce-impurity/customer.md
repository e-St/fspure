<!--
  ...
  Channel: preview | Ref: release/fspure-reduce-impurity | Version: 0.4.0
  Generated: 2026-08-12T21:26:53Z
-->
...
> Preview docs for `release/fspure-reduce-impurity`. Stable guide: [fspure.net](https://fspure.net) / [main README](https://github.com/e-St/fspure#60-second-install).
...
- Analyzer: **0.4.0**  
- Collector: **0.1.0**  
- Docs channel: **preview** (`release/fspure-reduce-impurity`)
