...
| **NuGet vulnerable scan** | `src/scripts/security-audit.sh` | `dotnet list package --vulnerable --include-transitive` on main projects |
...
NPM_AUDIT_LEVEL=moderate bash src/scripts/security-audit.sh
```
