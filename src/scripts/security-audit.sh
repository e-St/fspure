...
scan_nuget_project "src/tests/FSharp.PureSchema.Tests/FSharp.PureSchema.Tests.fsproj"
scan_nuget_project "src/FSharp.PureAnalyzer/FSharp.PureAnalyzer.fsproj"
scan_nuget_project "src/tests/FSharp.PureAnalyzer.Tests/FSharp.PureAnalyzer.Tests.fsproj"
scan_nuget_project "src/fspure-collector/fspure-collector.fsproj"
scan_nuget_project "src/tests/fspure-collector.Tests/fspure-collector.Tests.fsproj"
...
scan_nuget_project "src/tests/e2e/phase2/ScreenshotCapture/ScreenshotCapture.fsproj"
# (C# by necessity for MSBuild task hosting — see src/docs/LANGUAGES.md)
scan_nuget_project "src/DocsGenerator/DocsGenerator.fsproj"
scan_nuget_project "src/samples/fspure-ready-lib/src/Fspure.ReadyLib/Fspure.ReadyLib.fsproj"

# --- npm audit ---
section "npm audit (vscode-extension)"
if [[ -f src/editor/vscode-extension/package.json ]]; then
  if command -v npm >/dev/null 2>&1; then
    (
      cd src/editor/vscode-extension
