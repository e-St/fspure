...
|----------|----------|-----------|
| `.github/workflows/publish-vscode-extension.yml` | Push to `editor/vscode-extension/**` or manual | GitHub Release; Open VSX (`OVSX_PAT`) |
...
- **Extension:** bump `editor/vscode-extension/package.json` → `version` before merge.
