...
///
/// Implemented in C# deliberately: MSBuild task hosting requires a runtime type that
/// Activator can instantiate in the task host; F# task types hit
/// "Type must be a type provided by the runtime" under out-of-proc execution.
/// </summary>
