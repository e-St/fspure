...
BASE_ANALYZER="$(python3 -c "import json; print(json.load(open('docs/releases/manifest.json'))['lastOfficial']['FSharp.PureAnalyzer'])")"
BASE_COLLECTOR="$(python3 -c "import json; print(json.load(open('docs/releases/manifest.json'))['lastOfficial']['fspure-collector'])")"
